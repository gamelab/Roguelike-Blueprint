...
//TRIALS AND TRIBULATIONS, FOR POSTERITY
	// create a new random map
//	this.isDungeon = Math.random()<0.5;
//	this.isCrypt = Math.random()<0.5;
//	if(rand<1/3) {
...
//				item.type = this.LootTypes.POTION;
//			}
//		if(this!=isCrypt || this!=isDungeon) {
//			if(rand<1/3) {
//				item.type = this.LootTypes.WAND;
//			} else if(rand<2/3) {
//				item.type = this.LootTypes.PICKAXE;
...
PlayState.cleanUpDeadActor = function(victim) {
	...
	if (victim.hp <= 0) {
		...
		self.actorList[self.actorList.indexOf(victim)]=null;
				...
				//Uncommenting this gives me the wierdest bug I have /ever seen/
